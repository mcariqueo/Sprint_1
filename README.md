...
Esta base de datos consta de dos componentes principales:
  1. Tabla de hechos: transaction
      Contiene 9 campos con formatos que incluyen integer, float, fechas y caracteres.
      Esta tabla registra información detallada sobre las transacciones realizadas.
